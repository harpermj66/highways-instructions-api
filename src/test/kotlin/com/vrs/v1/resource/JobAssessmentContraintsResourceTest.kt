...
import com.vrs.v1.service.JobAssessmentContraintsService
...
@QuarkusTest
class JobAssessmentContraintsResourceTest {
    ...
    fun testListAll() {
        ...
        given()
            .`when`().get("/job-assessment-contraintss")
            .then()
            .statusCode(200)
            .body(`is`("[]"))
    }
    @Test
    fun testGetById() {
        val item = JobAssessmentContraints().apply { 
            job_assessment_contraints_id = 1L
            constraint = "test"
            created_by = "test"
        }
        ...
        given()
            .`when`().get("/job-assessment-contraintss/1")
            .then()
            .statusCode(200)
            .body("job_assessment_contraints_id", `is`(1))
    }
    ...
    fun testGetByIdNotFound() {
        ...
        given()
            .`when`().get("/job-assessment-contraintss/999")
            .then()
            .statusCode(404)
    }
    ...
    fun testAdd() {
        ...
        given()
            ...
            .body(item)
            .`when`().post("/job-assessment-contraintss")
            .then()
            .statusCode(201)
            .body("job_assessment_contraints_id", `is`(1))
    }
    ...
    fun testDelete() {
        ...
        given()
            .`when`().delete("/job-assessment-contraintss/1")
            .then()
            .statusCode(204)
    }
    ...
    fun testDeleteNotFound() {
        ...
        given()
            .`when`().delete("/job-assessment-contraintss/999")
            .then()
            .statusCode(404)
    }
}
