...
@QuarkusTest
class IncompleteJobInstructionsResourceTest {
    ...
    fun testListAll() {
        ...
        given()
            .`when`().get("/incomplete-job-instructionss")
            .then()
            .statusCode(200)
            .body(`is`("[]"))
    }
    @Test
    fun testGetById() {
        val item = IncompleteJobInstructions().apply { 
            ji_id = 1L
        ...
        given()
            .`when`().get("/incomplete-job-instructionss/1")
            .then()
            .statusCode(200)
            .body("ji_id", `is`(1))
    }
    ...
    fun testGetByIdNotFound() {
        ...
        given()
            .`when`().get("/incomplete-job-instructionss/999")
            .then()
            .statusCode(404)
    }
    ...
    fun testAdd() {
        ...
        given()
            ...
            .body(item)
            .`when`().post("/incomplete-job-instructionss")
            .then()
            .statusCode(201)
            .body("ji_id", `is`(1))
    }
    ...
    fun testDelete() {
        ...
        given()
            .`when`().delete("/incomplete-job-instructionss/1")
            .then()
            .statusCode(204)
    }
    ...
    fun testDeleteNotFound() {
        ...
        given()
            .`when`().delete("/incomplete-job-instructionss/999")
            .then()
            .statusCode(404)
    }
}
